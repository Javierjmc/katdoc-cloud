...
export default function AppShell({ children }: AppShellProps) {
  ...
  const handleLogout = () => {
    sessionStorage.removeItem('vetcare_auth');
...
function SidebarLink({ href, icon, label, active, highlight, collapsed }: {
  href: string; icon: string; label: string;
  active: boolean; highlight?: boolean; collapsed?: boolean;
}) {
  return (
    <Link
      href={href}
...
function MobileNavItem({ href, icon, label, active, highlight }: {
  href: string; icon: string; label: string; active: boolean; highlight?: boolean;
}) {
  return (
    <Link
      href={href}
